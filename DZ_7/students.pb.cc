...
const uint32_t TableStruct_students_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::students::Student, name_),
  PROTOBUF_FIELD_OFFSET(::students::Student, grades_),
  PROTOBUF_FIELD_OFFSET(::students::Student, avg_score_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_students_2eproto = {
  false, false, 251, descriptor_table_protodef_students_2eproto, "students.proto", 
...
Student::Student(const Student& from)
  ...
  if (from._internal_has_name()) {
    name_ = new ::students::FullName(*from.name_);
  } else {
    name_ = nullptr;
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:students.Student)
  ...
  if (from._internal_has_name()) {
    _internal_mutable_name()->::students::FullName::MergeFrom(from._internal_name());
  }
